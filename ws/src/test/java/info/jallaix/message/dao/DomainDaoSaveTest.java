...
@ContextConfiguration(classes = DomainDaoSaveTest.class)
public class DomainDaoSaveTest extends BaseDaoElasticsearchTestCase<Domain, String, DomainDao> {
    ...
    /**
     * Constructor defining the "save one" tests
     */
    public DomainDaoSaveTest() {
        super(DaoTestedMethod.Save.class);
    }
     ...
     */
    @Test
    public void saveExistingDomainWithMissingComplexButExistingSimpleLanguage() {
     ...
     */
    @Test
    public void saveExistingDomainWithExistingComplexLanguage() {
     ...
     */
    @Test
    public void saveExistingDomainWithMissingComplexAndSimpleLanguage() {
